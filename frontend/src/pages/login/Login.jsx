    ...
    <div className="flex flex-col items-center justify-center min-w-96 mx-auto">
      <div className="w-full p-6 rounded-lg shadow-md bg-gray-400 bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-5">
        ...
        <form action="">
          ...
          <a
            href="#"
            className="text-sm hover:underline hover:text-yellow-300 mt-2 inline-black"
          >
            {"Don't"} have an account?
          </a>
          <div>
            <button className="btn btn-block btn-sm mt-2 hover:text-yellow-300">Login</button>
          </div>
        </form>
      </div>
    </div>
